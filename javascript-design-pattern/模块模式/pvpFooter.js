...
var pvpFooter = (function(){
	...
	util.addFooterCSS = function(){
		var footerCSS = '';
			...
			footerCSS += '.footer-wrap .foot_ieg_logo{width:285px;height:64px;margin:0;background: url(http://game.gtimg.cn/images/yxzj/web201605/main/spr.png) no-repeat;}';
			footerCSS += '.footer-wrap .logo1{width:70px;height:64px;margin:0;background: url(http://game.gtimg.cn/images/yxzj/web201605/main/spr.png) no-repeat -285px 0;}';
