!function() {
  ...
  function b(b, c) {
      var d, e, f = new Image, g = c.__a, h = Math.floor(c._ / 100);
      if (g && h) {
          for (g += h,
          e = d = 0; e < g.length; e++)
              d += g.charCodeAt(e);
  ...
  function c(a, b, c, e) {
      var f, g = "";
      (location.hostname.indexOf(".zhipin.com") >= 0 || "zhipin.com" == location.hostname) && (e = "zhipin.com",
      d("__a"),
      d("__c"),
      d("__l")),
      c && (f = new Date,
  ...
  function g(a, b) {
      var c, d, g, h, i, j, k, o = [n, p, q, "t", "ab_t", "wt"], r = {};
      for (c = 0; c < o.length; c++)
          d = o[c],
          (g = e(d)) && (r[d] = g);
      if (h = document.referrer,
      h && location.hostname == l(h) && (h = f(h, location.hostname)),
      b ? r.e = (new Date).getTime() - m : window.performance && window.performance.timing && (i = window.performance.timing,
      i.fetchStart && (r.e = m - i.fetchStart)),
      r.r = h,
      r._ = Math.round((new Date).getTime() / 1e3),
      j = "undefined" != typeof _PK ? _PK : document.getElementById("page_key_name") && document.getElementById("page_key_name").getAttribute("value"),
      j && (r.pk = j),
      a)
          for (k in a)
              r[k] = a[k];
  ...
  function h() {
      ...
      if (!r) {
          ...
          z = {},
          g)
              for (0 === g.indexOf("%22") && (g = g.substr(3, g.length - 6)),
              g = g.split("&"),
              i = 0; i < g.length; i++)
                  y = g[i].split("="),
          ...
          d = g + "");
          a: {
              for (y = window.location.search.substring(1).split("&"),
              i = 0; i < y.length; i++)
                  if (h = y[i].split("="),
                  2 == h.length && "sid" == decodeURIComponent(h[0])) {
          ...
          h ? (h !== e(q) && (i = !0),
          c(q, h),
          z.g = f(location.href)) : (h = e(q),
          h || (h = "-",
          c(q, h))),
          c(p, a(z, "&")),
          b && 8 == b.split(".").length ? (x = b.split("."),
          j = x[0],
          k = x[1],
          l = x[2],
          m = x[3],
          ...
          m = d,
          u += 1,
          v = 1) : v += 1) : (j = Math.floor(1e8 * Math.random()),
          k = g,
          l = "",
          m = d,
          s = 1,
  ...
  var l, m, n, o, p, q, r, s, t = 0 <= location.hostname.indexOf("kanzhun.com") || 0 <= location.hostname.indexOf("bosszhipin") || 0 <= location.hostname.indexOf("nnhfg.com") || 0 <= location.hostname.indexOf(".zhipin.com") || 0 <= location.hostname.indexOf("dianzhangzhipin") || 0 <= location.hostname.indexOf("qqchx.com") || 0 <= location.hostname.indexOf("yushanapp.com") || 0 <= location.hostname.indexOf("zdzhushou.cc"), u = location.hostname.toLowerCase(), v = !1, w = "";
  0 <= u.indexOf("bosszhipin") || 0 <= u.indexOf("weizhipin") || 0 <= u.indexOf(".zhipin") || 0 <= u.indexOf(".yushanapp") || 0 <= u.indexOf(".zdzhushou") ? (v = !0,
  w = t ? "t.bosszhipin.com" : "t.weizhipin.com") : w = t ? "t.kanzhun.com" : "192.168.1.251",
  l = function() {
  ...
  window.onerror = function(a, b, c, d, e) {
      return "Script error." == a || b ? (setTimeout(function() {
          var a, f, g, h;
          if (d = d || window.event && window.event.errorCharacter || 0,
          h = d,
          e && e.stack)
              a = e.stack.toString();
  ...
  ,
  t && (s = e("t"),
  s && location.hostname && 0 <= location.hostname.indexOf("kanzhun.com") && (d("t"),
  c("t", s, 3650)))
}();
              ...
              if (k) {
                  ...
                  if (p && p.indexOf("#") !== 0 && p.indexOf("javascript:;") === -1 && !target.getAttribute("noa")) {
                      ...
                      if (flag) {
                          ...
                          } else if (p.indexOf("tel:") == -1 && p.indexOf("mailto:") == -1) {
                              //排除tel和mailto
