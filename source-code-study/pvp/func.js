if (typeof EAS != "object") {
  var EAS = (function() {
      ...
      var el = document
        , LogCgi = "//logs.game.qq.com/eas/comm/eas.php?"
        , LogCgiGo = "//logs.game.qq.com/easnew/go/eas.php?"
        , sendClickUrl = "http://apps.game.qq.com/adw_sendclick/api/send_click.php?"
        , GODMkUrl = "http://apps.game.qq.com/fifa/qiyehao/index.php?m=GODMLogin"
        , UrlPathName = window.location.pathname
        , UrlHost = window.location.host
        , UrlHref = window.location.href
        , ReferrerUrl = document.referrer
        , http_type = document.location.protocol
        , LogUrl = fnn.getEasUrl(UrlHref)
        , e_code = 0
        , g_code = 0
        , ad_id = 0
        , o2_mid = 0
      ...
      var Init = function() {
          if (!hasAMS && !hasSend) {
              ...
              var param = "click_type=3&e_code=" + e_code + "&o2_mid=" + o2_mid + "&Url=" + encodeURIComponent(LogUrl) + "&ReferrerUrl=" + encodeURIComponent(ReferrerUrl);
          ...
          if (UrlHost == "x5.qq.com" || UrlHost == "lol.qq.com") {
              ...
              while (AllElsLength--) {
                  ...
                  var oAttribute = ""
                    ...
                    , e_param = ""
                    , param = "";
                  HrefValue = oCurrEl.getAttribute && oCurrEl.getAttribute("href");
                  if (typeof HrefValue == "string" && HrefValue.length > 0) {
                      HrefCode = parseInt(fnn.getUrlVar(HrefValue, "e_code"));
                      if (HrefCode != null && HrefCode != undefined && HrefCode != 0) {
                  ...
                  oAttribute = oCurrEl.getAttribute && oCurrEl.getAttribute(EasADTAG);
      ...
      var SendClick = function(param, _callback) {
          if (typeof param == "object") {
              ...
              if (parseInt(_c_t) == 1) {
                  l_p_go = "show_ads=" + _e_c + "&Url=" + encodeURIComponent(LogUrl) + "&click_type=1"
              }
              if (parseInt(_c_t) == 2) {
                  l_p_go = "show_ads=" + _e_c + "&ad_url=" + encodeURIComponent(_clickurl) + "&ReferrerUrl=" + encodeURIComponent(LogUrl) + "&click_type=2";
                  _callback = function() {}
              }
              if (parseInt(_c_t) == 4) {
                      ...
                      if (adtagArr.length == 1) {
                          setTimeout(function() {
                              if (adtagArr.length > 0) {
                                  ...
                                  l_p_go = "click_type=4&adtag=" + _e_c + "&e_code=" + e_code + "&o2_mid=" + o2_mid + "&Url=" + encodeURIComponent(LogUrl) + "&ReferrerUrl=" + encodeURIComponent(ReferrerUrl);
                                  adtagArr = new Array();
                                  if (l_p_go) {
                                      if (typeof (_callback) === "function") {
              ...
              if (parseInt(_c_t) == 99 || parseInt(_c_t) == 100) {
                  l_p_go = "click_type=" + parseInt(_c_t) + "&e_code=" + _e_c + "&Url=" + encodeURIComponent(LogUrl) + "&ReferrerUrl=" + encodeURIComponent(ReferrerUrl)
              }
              if (parseInt(_c_t) == 101) {
                  if (_e_c.indexOf("|") != -1) {
                      tmp_codeArr = _e_c.split("|")
                  }
                  l_p_go = "click_type=101&e_code=" + _e_c + "&c_p=" + _c_p + "&Url=" + encodeURIComponent(LogUrl) + "&ReferrerUrl=" + encodeURIComponent(ReferrerUrl)
              }
              if (parseInt(_c_t) == 102) {
                  if (_clickurl) {
                      l_p_go = "click_type=102&e_code=" + _e_c + "&c_p=" + _c_p + "&Url=" + encodeURIComponent(_clickurl) + "&ReferrerUrl=" + encodeURIComponent(LogUrl)
                  } else {
                      l_p_go = "click_type=102&e_code=" + _e_c + "&c_p=" + _c_p + "&Url=" + encodeURIComponent(LogUrl) + "&ReferrerUrl=" + encodeURIComponent(LogUrl)
                  }
              }
              if (l_p_go) {
                  if (typeof (_callback) === "function") {
      ...
      var VShow = function(param, _callback) {
          ...
          if (typeof param == "object") {
              if (typeof param.VUrl == "object") {
                  if (param.VUrl.href !== null && param.VUrl.href !== undefined) {
              ...
              if (param.VType == "click") {
                  ...
                  if (param.VType == "play") {
                      param.ReferrerUrl = encodeURIComponent(fnn.getEasUrl(ReferrerUrl));
      ...
      var GODMInit = function(param) {
          ...
          var param = "m=SendLog&click_type=501&e_code=" + e_code + "&GODM_user=" + GODM_user + "&GODM_serviceType=" + GODM_serviceType + "&GODM_sysName=" + GODM_sysName + "&Url=" + encodeURIComponent(LogUrl) + "&ReferrerUrl=" + encodeURIComponent(ReferrerUrl);
      ...
      var GODMClick = function(param) {
          ...
          var param = "m=SendLog&click_type=502&GODM_adtag=" + GODM_adtag + "&e_code=" + e_code + "&GODM_user=" + GODM_user + "&GODM_serviceType=" + GODM_serviceType + "&GODM_sysName=" + GODM_sysName + "&Url=" + encodeURIComponent(LogUrl) + "&ReferrerUrl=" + encodeURIComponent(ReferrerUrl);
          SendLog(LogCgi, param, function() {})
      };
      var SysInit = function(param) {
          ...
          var param = "m=SendLog&click_type=503&e_code=" + e_code + "&Sys_userId=" + Sys_userId + "&Sys_openId=" + Sys_openId + "&Sys_channel=" + Sys_channel + "&Sys_serviceType=" + Sys_serviceType + "&Sys_sysName=" + Sys_sysName + "&Url=" + encodeURIComponent(LogUrl) + "&ReferrerUrl=" + encodeURIComponent(ReferrerUrl);
          SendLog(LogCgi, param, function() {})
      };
      var SysClick = function(param) {
          ...
          var param = "m=SendLog&click_type=504&Sys_adtag=" + Sys_adtag + "&e_code=" + e_code + "&Sys_userId=" + Sys_userId + "&Sys_openId=" + Sys_openId + "&Sys_channel=" + Sys_channel + "&Sys_serviceType=" + Sys_serviceType + "&Sys_sysName=" + Sys_sysName + "&Url=" + encodeURIComponent(LogUrl) + "&ReferrerUrl=" + encodeURIComponent(ReferrerUrl);
          SendLog(LogCgi, param, function() {})
      };
      var DJClick = function(DJActId) {
          ...
          var param = "click_type=98&e_code=" + e_code + "&o2_mid=" + o2_mid + "&DJActId=" + DJActId + "&Url=" + encodeURIComponent(LogUrl) + "&ReferrerUrl=" + encodeURIComponent(ReferrerUrl);
          SendLog(LogCgiGo, param, function() {})
      };
      var TimeLine = function() {
          EAS.addEvent(window, "beforeunload", function() {
              var EndTime = new Date().getTime();
              var param = "m=SendLog&click_type=601&e_code=" + e_code + "&StartTime=" + StartTime + "&EndTime=" + EndTime + "&Url=" + encodeURIComponent(LogUrl) + "&ReferrerUrl=" + encodeURIComponent(ReferrerUrl);
              Close = true;
              SendLog(LogCgi, param, function() {});
      ...
      var needjs = function(name, callback) {
          if (eval("EAS." + name) == undefined) {
              fnn.loadjs(http_type + "//ossweb-img.qq.com/images/js/eas/" + name + ".js", function() {
                  callback()
              })
          } else {
              if (typeof (eval("EAS." + name)) == "function" || typeof (eval("EAS." + name)) == "object") {
                  callback()
              }
          }
      };
  ...
  EAS.Init();
  if (window.location.host == "lol.qq.com" || window.location.host == "lpl.qq.com") {
      if (!EAS.browser.versions.android && !EAS.browser.versions.ios) {
          EAS.loadjs("//ossweb-img.qq.com/images/clientpop/js/rtpush/main3.js", function() {})
      }
  }
...
;/*  |xGv00|bac0c304e422ec0e168e6a2217168356 */
