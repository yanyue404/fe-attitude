function move(t, n, e, r, a) {
    ...
    for (var o in n)
        i[o] = {},
        "opacity" == o ? (i[o].b = Math.round(100 * css(t, o)),
        i[o].c = 100 * n[o] - i[o].b) : (i[o].b = parseInt(css(t, o)),
        i[o].c = n[o] - i[o].b);
    var r = r || "linear"
      , c = (new Date).getTime();
    t.iTimer = setInterval(function() {
        ...
        for (var o in n) {
            ...
            "opacity" == o ? (t.style[o] = f / 100,
            t.style.filter = "alpha(opacity=" + f + ")") : t.style[o] = f + "px"
        }
        e == u && (clearInterval(t.iTimer),
        a && a.call(t))
    }, 16)
}
function css(t, n) {
...
var Tween = {
    ...
    elasticIn: function(t, n, e, r, a, u) {
        ...
        !a || a < Math.abs(e)) {
            ...
            var i = u / (2 * Math.PI) * Math.asin(e / a);
    ...
    backOut: function(t, n, e, r, a) {
        ...
        e * ((t = t / r - 1) * t * ((a + 1) * t + a) + 1) + n
    },
    backBoth: function(t, n, e, r, a) {
        return "undefined" == typeof a && (a = 1.70158),
        (t /= r / 2) < 1 ? e / 2 * t * t * (((a *= 1.525) + 1) * t - a) + n : e / 2 * ((t -= 2) * t * (((a *= 1.525) + 1) * t + a) + 2) + n
    },
