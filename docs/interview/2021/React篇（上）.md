...
![pic_a5fb3c67.png](https://www.liangtengyu.com:9998/images/pic_a5fb3c67.png)
...
除此之外，冒泡到 document 上的事件也不是原生的浏览器事件，而是由 react 自己实现的合成事件（SyntheticEvent）。因此如果不想要是事件冒泡的话应该调用 event.preventDefault()方法，而不是调用 event.stopProppagation()方法。 ![pic_365b79ef.png](https://www.liangtengyu.com:9998/images/pic_365b79ef.png) JSX 上写的事件并没有绑定在对应的真实 DOM 上，而是通过事件代理的方式，将所有的事件都统一绑定在了 `document` 上。这样的方式不仅减少了内存消耗，还能在组件挂载销毁时统一订阅和移除事件。
...
不可以，render 阶段 DOM 还没有生成，无法获取 DOM。DOM 的获取需要在 pre-commit 阶段和 commit 阶段： ![pic_f6f092b1.png](https://www.liangtengyu.com:9998/images/pic_f6f092b1.png)
...
![pic_202e7daf.png](https://www.liangtengyu.com:9998/images/pic_202e7daf.png) 具体的执行过程如下（源码级解析）：
...
![pic_1de5105c.png](https://www.liangtengyu.com:9998/images/pic_1de5105c.png)
...
React 常见的生命周期如下： ![pic_760e0289.png](https://www.liangtengyu.com:9998/images/pic_760e0289.png) React 常见生命周期的过程大致如下：
...
state 更新流程： ![pic_13f20df7.png](https://www.liangtengyu.com:9998/images/pic_13f20df7.png) 这个过程当中涉及的函数：
...
props 更新流程： ![pic_2c0a1e9b.png](https://www.liangtengyu.com:9998/images/pic_2c0a1e9b.png) 相对于 state 更新，props 更新后唯一的区别是增加了对 componentWillReceiveProps 的调用。关于 componentWillReceiveProps，需要知道这些事情：
...
关于 React16 开始应用的新生命周期： ![pic_c2378622.png](https://www.liangtengyu.com:9998/images/pic_c2378622.png) 可以看出，React16 自上而下地对生命周期做了另一种维度的解读：
...
- BrowserRouter 创建的 URL 格式：[xxx.com/path][xxx.com_path]
- HashRouter 创建的 URL 格式：[xxx.com/\#/path][xxx.com_path 1]
