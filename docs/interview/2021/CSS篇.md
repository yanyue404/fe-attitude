...
注：2021.5.21 已更新，修改文中出现的部分错误。添加了思维导图，根据我自己的面试经历以及牛客网等平台的面经，将面试题的考察频率进行大致的区分，可以针对性的进行复习。

#### 前端面试题系列文章：

【1】[「2021」高频前端面试题汇总之 HTML 篇][2021_html]

【2】[「2021」高频前端面试题汇总之 CSS 篇][2021_css]

【3】[「2021」高频前端面试题汇总之 JavaScript 篇（上）][2021_javascript]

【4】[「2021」高频前端面试题汇总之 JavaScript 篇（下）][2021_javascript 1]

【5】[「2021」高频前端面试题汇总之 Vue 篇（上）][2021_vue]

【6】[「2021」高频前端面试题汇总之 Vue 篇（下）][2021_vue 1]

【7】[「2021」高频前端面试题汇总之 React 篇（上）][2021_react]

【8】[「2021」高频前端面试题汇总之 React 篇（下）][2021_react 1]

【9】[「2021」高频前端面试题汇总之计算机网络篇][2021]

【10】[「2021」高频前端面试题汇总之浏览器原理篇][2021 1]

【11】[「2021」高频前端面试题汇总之性能优化篇][2021 2]

【12】[「2021」高频前端面试题汇总之手写代码篇][2021 3]

【13】[「2021」高频前端面试题汇总之代码输出结果篇][2021 4]

![pic_78bdaf92.png](https://www.liangtengyu.com:9998/images/pic_78bdaf92.png)
...
CSS3 中的盒模型有以下两种：标准盒子模型、IE 盒子模型 ![pic_24f5abc9.png](https://www.liangtengyu.com:9998/images/pic_24f5abc9.png) ![pic_464c92df.png](https://www.liangtengyu.com:9998/images/pic_464c92df.png) 盒模型都是由四个部分组成的，分别是 margin、border、padding 和 content。
...
对于图片来说，为了保证其不失真，1 个图片像素至少要对应一个物理像素，假如原始图片是 500300 像素，那么在 3 倍屏上就要放一个 1500900 像素的图片才能保证 1 个物理像素至少对应一个图片像素，才能不失真。 ![pic_50e238ce.png](https://www.liangtengyu.com:9998/images/pic_50e238ce.png) 当然，也可以针对所有屏幕，都只提供最高清图片。虽然低密度屏幕用不到那么多图片像素，而且会因为下载多余的像素造成带宽浪费和下载延迟，但从结果上说能保证图片在所有屏幕上都不会失真。
...
预处理器，其实就是 CSS 世界的“轮子”。预处理器支持我们写一种类似 CSS、但实际并不是 CSS 的语言，然后把它编译成 CSS 代码： ![pic_6efdca97.png](https://www.liangtengyu.com:9998/images/pic_6efdca97.png) 那为什么写 CSS 代码写得好好的，偏偏要转去写“类 CSS”呢？这就和本来用 JS 也可以实现所有功能，但最后却写 React 的 jsx 或者 Vue 的模板语法一样——为了爽！要想知道有了预处理器有多爽，首先要知道的是传统 CSS 有多不爽。随着前端业务复杂度的提高，前端工程中对 CSS 提出了以下的诉求：
...
![pic_f3b4fd63.png](https://www.liangtengyu.com:9998/images/pic_f3b4fd63.png) 它和预处理器的不同就在于，预处理器处理的是 类 CSS，而 PostCss 处理的就是 CSS 本身。Babel 可以将高版本的 JS 代码转换为低版本的 JS 代码。PostCss 做的是类似的事情：它可以编译尚未被浏览器广泛支持的先进的 CSS 语法，还可以自动为一些需要额外兼容的语法增加前缀。更强的是，由于 PostCss 有着强大的插件机制，支持各种各样的扩展，极大地强化了 CSS 的能力。
...
![pic_c08a2338.png](https://www.liangtengyu.com:9998/images/pic_c08a2338.png)
...
层叠顺序，英文称作 stacking order，表示元素发生层叠时有着特定的垂直显示顺序。下面是盒模型的层叠规则： ![pic_2b53e7c7.png](https://www.liangtengyu.com:9998/images/pic_2b53e7c7.png) 对于上图，由上到下分别是： （1）背景和边框：建立当前层叠上下文元素的背景和边框。 （2）负的 z-index：当前层叠上下文中，z-index 属性值为负的元素。 （3）块级盒：文档流内非行内级非定位后代元素。 （4）浮动盒：非定位浮动元素。 （5）行内盒：文档流内行内级非定位后代元素。 （6）z-index:0：层叠级数为 0 的定位元素。 （7）正 z-index：z-index 属性值为正的定位元素。
...
![pic_42df9b63.png](https://www.liangtengyu.com:9998/images/pic_42df9b63.png)

- fixed： 元素的定位是相对于 window （或者 iframe）边界的，和其他元素没有关系。但是它具有破坏性，会导致其他元素位置的变化。

![pic_12e8a403.png](https://www.liangtengyu.com:9998/images/pic_12e8a403.png)

- absolute： 元素的定位相对于前两者要复杂许多。如果为 absolute 设置了 top、left，浏览器会根据什么去确定它的纵向和横向的偏移量呢？答案是浏览器会递归查找该元素的所有父元素，如果找到一个设置了`position:relative/absolute/fixed`的元素，就以该元素为基准定位，如果没找到，就以浏览器边界定位。如下两个图所示：

![pic_113fdf49.png](https://www.liangtengyu.com:9998/images/pic_113fdf49.png) ![pic_75c49e84.png](https://www.liangtengyu.com:9998/images/pic_75c49e84.png)
...
将元素的长宽都设置为 0，显示出来的效果是这样的： ![pic_3b0d8110.png](https://www.liangtengyu.com:9998/images/pic_3b0d8110.png) 所以可以根据 border 这个特性来绘制三角形： （1）三角 1

```java
div {    width: 0;    height: 0;    border-top: 50px solid red;    border-right: 50px solid transparent;    border-left: 50px solid transparent;}
```

![pic_f6431af6.png](https://www.liangtengyu.com:9998/images/pic_f6431af6.png) （2）三角 2
...
![pic_b8ba3017.png](https://www.liangtengyu.com:9998/images/pic_b8ba3017.png) （3）三角 3
...
![pic_30fd0a05.png](https://www.liangtengyu.com:9998/images/pic_30fd0a05.png) （4）三角 4
...
![pic_e2a1f184.png](https://www.liangtengyu.com:9998/images/pic_e2a1f184.png) （5）三角 5
...
![pic_1b8feb81.png](https://www.liangtengyu.com:9998/images/pic_1b8feb81.png) 还有很多，就不一一实现了，总体的原则就是通过上下左右边框来控制三角形的方向，用边框的宽度比来控制三角形的角度。
...
![pic_d03041ab.png](https://www.liangtengyu.com:9998/images/pic_d03041ab.png)
...
打开 Chrome 浏览器，启动移动端调试模式，在控制台去输出这个 `devicePixelRatio` 的值。这里选中 iPhone6/7/8 这系列的机型，输出的结果就是 2： ![pic_2fb69997.png](https://www.liangtengyu.com:9998/images/pic_2fb69997.png) 这就意味着设置的 1px CSS 像素，在这个设备上实际会用 2 个物理像素单元来进行渲染，所以实际看到的一定会比 1px 粗一些。 解决 1px 问题的三种思路：
