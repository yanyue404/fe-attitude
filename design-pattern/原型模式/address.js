...
(function() {
  ...
  Address.prototype = {
    ...
    init: function() {
      ...
      for (var i = 0; i < this.Opt.showArr.length; i++) {
        ...
        html +=
          ...
          '" id="' +
          this.Opt.showArr[i] +
          '"><p class="address-btn">请选择</p><ul class="address-lists">';
      ...
      document.addEventListener(
        ...
        function(e) {
          ...
          if (
            util.hasClass(target, 'address-position') > 0 ||
            util.parents(target, 'address-position')
          )
            return;
          _this.closeUl();
        },
    ...
    renderList: function(ul, li, id) {
      ...
      for (var i = 0; i < this.Opt.showArr.length; i++) {
        if (i > index)
          this.elem_contain.children[i].children[0].innerText = '请选择';
      }
      ...
      if (index < this.Opt.showArr.length - 1) {
        index++;
        next_ul = document
          .getElementById(this.Opt.showArr[index])
          .getElementsByTagName('ul')[0];
        var obj = citys[li.innerText];
        if (index == 2)
          obj =
            citys[this.elem_contain.children[0].children[0].innerText][
              li.innerText
            ];
