<!-- https://github.com/vuejs/vue-cli/blob/a09407dd5b9f18ace7501ddb603b95e31d6d93c0/packages/@vue/cli-ui/src/components/folder/FolderExplorer.vue -->
<template>
  <div
  ...
  >
    <div class="toolbar">
      ...
      >
        <ApolloSubscribeToMore :document="require('@/graphql/cwd/cwdChanged.gql')" :update-query="cwdChangedUpdate" />

        <template slot-scope="{ result: { data } }">
          <div v-if="data" class="path-value">
            <div v-for="(slice, index) of slicePath(data.cwd)" :key="index" class="path-part">
              <VueButton
      ...
      <VueIcon v-if="error" icon="error" class="error-icon big" v-tooltip="error.message" />
    ...
    >
      <div class="default-body">
        ...
        >
          <VueInput v-model="newFolderName" icon-left="folder" v-focus @keyup.enter="createFolder()" />
        </VueFormField>
      </div>
